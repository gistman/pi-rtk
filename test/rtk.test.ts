...
import type { RtkRuntimeState } from "../src/types.js";

function createFakeRtk(scriptBody: string): string {
...
function createState(): RtkRuntimeState {
